	...
	private static Set<String> defaultPermissions(PlayerTag tag) {
		...
		return switch (tag) {
			case OWNER -> Set.of(
				...
				GexpressPermissions.PERMISSION_GAME_START,
				GexpressPermissions.PERMISSION_SETUP_COMMANDS,
				GexpressPermissions.PERMISSION_MAP_COMMANDS,
				GexpressPermissions.PERMISSION_TRAIN_COMMANDS,
				GexpressPermissions.PERMISSION_RTP_COMMANDS,
				GexpressPermissions.PERMISSION_ROLE_COMMANDS,
				GexpressPermissions.PERMISSION_MODIFIER_COMMANDS,
				GexpressPermissions.PERMISSION_SERVER_ACCESS_COMMANDS,
				GexpressPermissions.PERMISSION_VOICE_COMMANDS,
				GexpressPermissions.PERMISSION_BUG_REPORTS_MODERATE,
				GexpressPermissions.PERMISSION_SKINS_MANAGE,
				GexpressPermissions.PERMISSION_ECONOMY_MANAGE,
				GexpressPermissions.PERMISSION_PROGRESSION_MANAGE,
				GexpressPermissions.PERMISSION_DIAGNOSTICS,
				GexpressPermissions.PERMISSION_PLAYERS_TAB,
				GexpressPermissions.PERMISSION_GAME_TAB,
				GexpressPermissions.PERMISSION_GAME_TAB_EDIT,
				GexpressPermissions.PERMISSION_MAPS_TAB,
				GexpressPermissions.PERMISSION_MAPS_TAB_EDIT,
				GexpressPermissions.PERMISSION_TRAIN_CARTS_TAB,
				GexpressPermissions.PERMISSION_TRAIN_CARTS_TAB_EDIT,
				GexpressPermissions.PERMISSION_DEV_TAB,
				GexpressPermissions.PERMISSION_DEV_TAB_EDIT,
