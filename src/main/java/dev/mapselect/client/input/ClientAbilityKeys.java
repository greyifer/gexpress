...
public final class ClientAbilityKeys {
	...
	private static KeyBinding tertiaryBinding;
	...
	public static void register() {
		...
		tertiaryBinding = KeyBindingHelper.registerKeyBinding(new KeyBinding(
			"key.gexpress.tertiary_ability",
			InputUtil.Type.KEYSYM,
			GLFW.GLFW_KEY_V,
			"category.gexpress"
		));
	...
	public static KeyBinding tertiaryBinding() {
		return tertiaryBinding;
	}
