			...
			(payload, context) -> {
				...
				server.execute(() -> {
					...
					GexpressConfig.apply(payload.c4Price(), payload.c4FuseSeconds(),
						...
						payload.snitchTasksRequired(), payload.maxKillerAmount(),
						...
						payload.c4BackSlant(), payload.c4BackScale(), payload.shortSightedFogRange(),
